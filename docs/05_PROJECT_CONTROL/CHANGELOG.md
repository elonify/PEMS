...
- **Phase 1H presentation first-slice IMPLEMENTED** (2026-08-04): PySide6 shell + nav; RunService; RESULTS KPI / Case / Law / Production / Costs / Fiscal / NCF tables; format + IRR→GRR unavailable path; PT unit tests; report `PHASE1H_PRESENTATION_IMPLEMENTATION.md`; **NUMERICALLY VALIDATED NOT CLAIMED**; charts/MC deferred; GM SHA `D07560CA…BFEA` MATCH  
- **Phase 1H presentation/UI readiness READY** (2026-08-04): report `PHASE1H_PRESENTATION_READINESS.md`; surfaces/KPI/chart/table/selector contracts; calc→presentation boundary; error/units/IA; first-slice implementation ready pending PO auth; **IMPLEMENTED NO**; **VALIDATED NOT CLAIMED**; sensitivity/MC deferred; GM SHA `D07560CA…BFEA` MATCH  
